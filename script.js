...
async function initializeFirebase() {
    const { initializeApp } = await loadFirebaseModule('app');
    ...
    const firestoreModule = await loadFirebaseModule('firestore');
    const { getFirestore, collection, getDocs, addDoc, doc, updateDoc, deleteDoc, getDoc, Timestamp } = firestoreModule;

    db = getFirestore();
    return { db, collection, getDocs, addDoc, doc, updateDoc, deleteDoc, getDoc, Timestamp };
}
